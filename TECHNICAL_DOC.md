...
### 流程概览
$$
\text{Input (Multiplex Graph)} \xrightarrow{\text{GMA Engine}} \text{Alignment \& Attention} \xrightarrow{\text{MFEA Engine}} \text{Evolution \& Transfer} \xrightarrow{\text{Output}} \text{Optimal Seeds}
$$
